...
const Home = () => {
  return (
    <main>
      {/* Hero Section */}
      <section className="hero" style={{ marginTop: '80px', position: 'relative', background: "linear-gradient(rgba(43, 43, 43, 0.7), rgba(43, 43, 43, 0.7)), url('assets/images/hero_banner_1781538815611.png') center/cover", padding: '120px 0', color: 'white', textAlign: 'center' }}>
        <div className="container animate-up">
          ...
          <div style={{ display: 'flex', gap: '20px', justifyContent: 'center' }}>
            ...
            <Link to="/about" className="btn" style={{ backgroundColor: 'white', color: 'var(--color-primary-dark)' }}>Learn More</Link>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <Link to="/initiatives" style={{ display: 'inline-block', marginTop: '15px', fontWeight: '600' }}>Read More <i className="fas fa-arrow-right"></i></Link>
              </div>
            </div>
      ...
      <section className="section" style={{ backgroundColor: 'var(--color-secondary-light)', textAlign: 'center' }}>
        <div className="container">
          <h2 className="section-title" style={{ color: 'var(--color-primary-dark)' }}>Join Us in Making a Difference</h2>
          ...
          <Link to="/contact" className="btn btn-outline" style={{ borderColor: 'var(--color-primary-dark)', color: 'var(--color-primary-dark)' }}>Become a Volunteer</Link>
        </div>
      </section>
    </main>
  );
